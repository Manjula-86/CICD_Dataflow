...
public class CICDDataflowDemoApplication implements CommandLineRunner {

	public static void main(String[] args) {
		
		System.out.println("STARTING THE APPLICATION");
		SpringApplication.run(CICDDataflowDemoApplication.class, args);
	    ...
	    public void run(String... args) {
	        ...
	        String datasetName = "CUSTOMER3_US";
		    String location = "US";
		    
		    
		    datasetName = createDataset(datasetName,location);
		    String tableName = "CUSTOMER3";
		    Schema schema =
		        Schema.of(
